...
void LevelObject::Initialise( void )
{
	CBL_GAME.Services.Get<LevelManager>()->Add( this );
}

void LevelObject::Shutdown( void )
{
	CBL_GAME.Services.Get<LevelManager>()->Remove( this );
}
